...
class CategoryControllerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $url_invoke = getenv('HOST').'/todo/category-service/web/category/createCategory';
        $category = [
            'name'  => 'dummy',
            'user_id'=> 1
        ];
    ...
    {
        $url_invoke = getenv('HOST').'/todo/category-service/web/category/selectCategory/1';
    ...
    {
        $url_invoke = getenv('HOST').'/todo/category-service/web/category/listAllCategories';
    ...
    {
        $url_invoke = getenv('HOST').'/todo/category-service/web/category/deleteCategory';
        $category = [
            'category_id'  => 1,
        ];
